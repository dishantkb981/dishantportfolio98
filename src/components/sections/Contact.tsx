    ...
    >
      <div className="max-w-4xl w-full space-y-8">
        ...
        >
          ...
          <p className="mt-4 text-xl text-gray-300">Get in touch for collaboration or just to say hello!</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <motion.div 
            ...
            className="bg-gray-800 rounded-xl p-8 shadow-2xl overflow-hidden"
          >
