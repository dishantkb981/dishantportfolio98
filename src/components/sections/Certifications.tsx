...
<<<<<<< HEAD
      ...
      icon: Shield,
      color: "#1F77B4",
      logo: "/cert-logos/advent-cyber-2022.png",
      description: "Cybersecurity challenge event focusing on practical security skills and holiday-themed scenarios.",
      skills: ["Cybersecurity Challenges", "Practical Security Skills", "CTF Techniques"],
      verificationLink: "#"
    },
    {
      ...
      icon: Globe,
      color: "#00ff88",
      logo: "/cert-logos/advent-cyber-2023.png",
      description: "Annual cybersecurity challenge event with advanced security scenarios and skill development.",
      skills: ["Advanced Security Challenges", "Incident Response", "Threat Hunting"],
      verificationLink: "#"
    },
    {
      ...
      icon: Code,
      color: "#ff6b00",
      logo: "/cert-logos/advent-cyber-2024.png",
